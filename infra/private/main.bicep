...
Clinic Voice Agent - NICE Voice Scheduling Assistant
-----------------------------------
*/
...
param firstProjectName string = 'cvproj'

@description('This project will be a sub-resource of your account')
param projectDescription string = 'Clinic Voice Agent - Voice Scheduling Assistant with MAF'

@description('The display name of the project')
param displayName string = 'Clinic Voice Agent'
...
param vnetName string = 'clinic-voice-agent-vnet'
