#!/bin/bash
# Deploy Clinic Voice Agent infrastructure (public networking)
...
echo "🚀 Clinic Voice Agent - Public Infrastructure Deployment"
...
echo "   ✓ App hosting deployed"
echo "   Container App: $CONTAINER_APP_URL"
echo "   Registry: $ACR_LOGIN"

# Generate .env file
echo ""
echo "4️⃣ Generating .env configuration..."
cat > ../../.env.azure <<EOF
# Generated by deploy.sh on $(date)
# Clinic Voice Agent - Azure Configuration
...
# Get API key from Azure Portal → AI Search → Keys
...
echo "  2. Add AZURE_SEARCH_API_KEY from Azure Portal"
echo "  3. Build and push container image"
echo "  4. Configure NICE integration with Voice Gateway endpoint"
echo ""
